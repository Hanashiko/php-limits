...
INI_FILES=$(find /etc/php -name "php.ini" | grep -E "fpm|apache2")
...
echo "-----------------------------------------------------"
echo "Перезавантаження сервісів для застосування змін..."
...
echo "Готово! Перевірте значення вашим першим скриптом."
