...
`post_max_size` - обробляє завантаження через POST запити, але оскільки запити містять не тільки файл а ще +текстові поля, заголовки, метадані, то цей ліміт це +8M від переданого числа в другому аргументі скрипта
